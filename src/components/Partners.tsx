...
export function Partners() {
  ...
  return (
    <section className="relative overflow-hidden bg-white py-12 sm:py-16 md:py-20 lg:py-24">
      {/* Header */}
      <div className="container mb-8 sm:mb-12 md:mb-16 px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <div className="mb-3 sm:mb-4 inline-flex items-center gap-1.5 sm:gap-2 rounded-full bg-primary-100/50 px-2.5 sm:px-3 py-1 text-[10px] sm:text-xs font-medium text-primary-800">
          ...
          <h2 className="mb-3 sm:mb-4 text-xl sm:text-2xl md:text-3xl lg:text-4xl font-extrabold text-gray-900 font-benzin">
            Des entreprises professionnelles{' '}
            <span className="text-primary-700">nous font confiance</span>
          </h2>

          <p className="mx-auto max-w-4xl text-xs sm:text-sm text-gray-600 font-montserrat px-4">
        ...
        <div className="flex animate-scroll-left hover:[animation-play-state:paused]">
          ...
          {doubledPartners.map((partner, index) => (
            <div
              ...
              className="group flex min-w-[180px] sm:min-w-[220px] md:min-w-[250px] flex-shrink-0 items-center justify-center px-3 sm:px-4 md:px-6"
            >
              <div className="relative overflow-hidden rounded-lg sm:rounded-xl md:rounded-2xl bg-white p-4 sm:p-6 md:p-8 shadow-md transition-all duration-300 hover:shadow-xl hover:scale-105">
                {/* Logo */}
