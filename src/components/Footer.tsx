    ...
    <footer className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white overflow-hidden">
      ...
      <div className="container relative py-16 lg:py-20">
        ...
        <div className="grid gap-12 lg:grid-cols-2 mb-16">
          ...
          <div>
            <div className="mb-8">
              <h2 className="text-4xl font-bold mb-4 font-benzin">
                <span className="text-primary-400">Wim</span><span className="text-white">Assur</span>
              </h2>
              <p className="text-gray-300 text-lg mb-6 font-montserrat max-w-md">
                {company.description}
              </p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              <h3 className="text-xl font-semibold mb-3 font-benzin">Restez informé</h3>
              <p className="text-gray-300 mb-4 text-sm font-montserrat">Recevez nos dernières actualités et conseils</p>
              ...
              {showSuccess ? (
                <div className="flex items-center gap-2 text-green-400 py-3">
                  ...
                  <span className="font-montserrat">Merci pour votre inscription !</span>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="flex gap-2">
                  <input
                    ...
                    className="flex-1 rounded-lg bg-white/10 px-4 py-2 text-white placeholder-gray-400 backdrop-blur-sm border border-white/20 focus:outline-none focus:border-primary-400 focus:ring-1 focus:ring-primary-400"
                    required
                  />
                  <button
                    type="submit"
                    disabled={isSubmitting}
                    className="rounded-lg bg-primary-600 px-6 py-2 font-semibold text-white transition-all hover:bg-primary-700 hover:shadow-lg disabled:opacity-50"
                  >
            ...
            <div className="flex gap-4 mt-8">
              <a
                ...
                className="group flex h-12 w-12 items-center justify-center rounded-full bg-white/10 backdrop-blur-sm transition-all hover:bg-primary-600 hover:scale-110"
                aria-label="Facebook"
              >
          ...
          <div className="grid grid-cols-2 gap-8 lg:grid-cols-3">
            {/* Contact */}
            <div>
              <h3 className="mb-6 text-lg font-semibold font-benzin text-primary-400">Contact</h3>
              <address className="space-y-3 not-italic text-gray-300 font-montserrat">
                ...
                <div className="flex items-start gap-3">
                  <svg className="h-5 w-5 text-primary-400 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* Quick links */}
            <div>
              <h3 className="mb-6 text-lg font-semibold font-benzin text-primary-400">Liens rapides</h3>
            ...
            {/* Legal info */}
            <div>
              <h3 className="mb-6 text-lg font-semibold font-benzin text-primary-400">Informations légales</h3>
              <div className="space-y-3">
                <div className="flex items-center gap-2 text-sm text-gray-300 font-montserrat">
        ...
        <div className="flex flex-wrap gap-6 justify-center py-8 border-t border-white/10">
          <div className="flex items-center gap-3 bg-white/5 backdrop-blur-sm rounded-lg px-4 py-2 border border-white/10">
            ...
            <span className="text-sm font-montserrat">Courtier agréé ORIAS</span>
          </div>
          <div className="flex items-center gap-3 bg-white/5 backdrop-blur-sm rounded-lg px-4 py-2 border border-white/10">
            <svg className="h-6 w-6 text-primary-400" fill="currentColor" viewBox="0 0 20 20">
            ...
            <span className="text-sm font-montserrat">Membre de la CSCA</span>
          </div>
          <div className="flex items-center gap-3 bg-white/5 backdrop-blur-sm rounded-lg px-4 py-2 border border-white/10">
            <svg className="h-6 w-6 text-primary-400" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018 0zm-.464 4.95l.707.707a1 1 0 001.414-1.414l-.707-.707a1 1 0 00-1.414 1.414zm2.12-10.607a1 1 0 010 1.414l-.706.707a1 1 0 11-1.414-1.414l.707-.707a1 1 0 011.414 0zM17 11a1 1 0 100-2h-1a1 1 0 100 2h1zm-7 4a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1zM5.05 6.464A1 1 0 106.465 5.05l-.708-.707a1 1 0 00-1.414 1.414l.707.707zm1.414 8.486l-.707.707a1 1 0 01-1.414-1.414l.707-.707a1 1 0 011.414 1.414zM4 11a1 1 0 100-2H3a1 1 0 000 2h1z" clipRule="evenodd" />
            </svg>
            <span className="text-sm font-montserrat">Certifié ISO 9001</span>
          </div>
        </div>
